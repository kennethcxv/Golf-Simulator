...
//
// Asset 66 remains campaign-mounted here. Asset 61 is owned exclusively by the
// unified 51-100 runtime so the reception shell cannot load twice or disagree
// about its canonical FRONT_DESK_FRAME pose.

import * as THREE from 'three';
import { OFFICE } from '../../data/shopLayout.js';
import { facilityInstalled } from '../../sim/campaign.js';
import { ASSET_066 } from './sheet07Manifest.js';
