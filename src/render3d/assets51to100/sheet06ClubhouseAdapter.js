...
// Asset 51's compact authored depth is 10.50 m, so its south facade/socket is
// 5.25 m from the origin. Direct modules use that authored datum so their
// registration stays exact after the starter clubhouse reduction.
export const SHEET06_AUTHORED_FRONT_Z_YARDS = 5.25 * METERS_TO_YARDS;
