...
export const SHOP_CATALOG = [
  ...
  { id: 'cap1', cat: 'apparel', tier: 1, name: 'Pine Hills cap', brand: 'PINE HILLS', cost: 8, msrp: 22, lb: 0.25 },
  { id: 'cap2', cat: 'apparel', tier: 2, name: 'Heritage rope cap', cost: 13, msrp: 30, lb: 0.25 },
  { id: 'visor1', cat: 'apparel', tier: 1, name: 'Pine Hills visor', brand: 'PINE HILLS', cost: 7, msrp: 20, lb: 0.18 },
  ...
  { id: 'scorecard1', cat: 'accessories', tier: 1, name: 'Pine Hills scorecard', cost: 0.5, msrp: 2, lb: 0.05, form: 'scorecard' },
...
// valid placement anchors per decor sku, in BUILDING-local yards (the compact
// 18.4 x 11.5 yd plan in src/data/shopLayout.js, door at +z).
...
export const DECOR_SPOTS = {
  ...
  plant1: [
    { x: -2.75, z: 5.15, ry: 0, mount: 'floor' },    // inside the door, west
    { x: -7.45, z: 4.30, ry: 0, mount: 'floor' },    // past the putter corner
    { x: 3.55, z: -5.15, ry: 0, mount: 'floor' },    // lounge edge
    { x: 8.35, z: 2.60, ry: 0, mount: 'floor' },     // office corner
  ],
  poster1: [
    { x: -6.6, z: 5.49, ry: Math.PI, mount: 'wall' },       // south wall pier between windows
    { x: -2.0, z: -5.49, ry: 0, mount: 'wall' },            // north wall, above the small shelf
    { x: 5.78, z: 0.5, ry: -Math.PI / 2, mount: 'wall' },  // partition, by the shoe wall
  ],
  board1: [
    { x: 0.95, z: 5.49, ry: Math.PI, mount: 'wall' },       // beside the door, inside
    { x: 8.94, z: -2.0, ry: -Math.PI / 2, mount: 'wall' }, // stockroom receiving wall
  ],
  light1: [
