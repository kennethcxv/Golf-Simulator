...
import { PRO_SHOP_FURNITURE_SKUS } from './proShopFurniture.js';
import { CEILING_LIGHT_SKUS } from './ceilingLights.js';
...
const PRODUCT_SPECS = [
  ...
  product({ skuId: 'putter3', status: 'retail', category: 'clubs', physical: dimensions(0.98, 0.054, 0.057), packed: dimensions(1.01, 0.07, 0.09), packedState: 'head-and-shaft-guarded', packedOrientation: 'lengthwise-heads-opposed', layoutId: 'CLUB2', unitWeightLb: 1.2, longProduct: true, fixtureIds: RETAIL_FIXTURES.putter }),
  ...
  product({ skuId: 'pants2', status: 'retail', category: 'apparel', physical: dimensions(0.24, 0.10, 0.20), packed: dimensions(0.22, 0.10, 0.19), packedState: 'folded-with-tissue-and-size-tag', packedOrientation: 'waist-label-face-up', layoutId: 'APPAREL8', unitWeightLb: 1, fixtureIds: RETAIL_FIXTURES.polo }),
  product({ skuId: 'shorts1', status: 'retail', category: 'apparel', physical: dimensions(0.22, 0.09, 0.19), packed: dimensions(0.21, 0.09, 0.18), packedState: 'folded-with-tissue-and-size-tag', packedOrientation: 'waist-label-face-up', layoutId: 'APPAREL8', unitWeightLb: 0.7, fixtureIds: RETAIL_FIXTURES.polo }),
  ...
  product({ skuId: 'visor1', status: 'retail', category: 'apparel', physical: dimensions(0.208, 0.07, 0.21), packed: dimensions(0.208, 0.05, 0.21), packedState: 'nested-visors-with-tissue-form', packedOrientation: 'bills-aligned-face-front', layoutId: 'CAP_NEST8', unitWeightLb: 0.18, fixtureIds: RETAIL_FIXTURES.cap }),
  ...
  product({ skuId: 'divot1', status: 'retail', category: 'accessories', physical: dimensions(0.13, 0.10, 0.02), packed: dimensions(0.13, 0.10, 0.02), packedState: 'sealed-retail-blister-card', packedOrientation: 'card-face-up', layoutId: 'ACCESSORY_CARD12', unitWeightLb: 0.15, fixtureIds: RETAIL_FIXTURES.accessories }),
  product({ skuId: 'range2', status: 'retail', category: 'accessories', physical: dimensions(0.1900, 0.1023, 0.1435), packed: dimensions(0.1900, 0.1023, 0.1435), packedState: 'retail-box-in-padded-cell', packedOrientation: 'display-face-up', layoutId: 'RANGE4', unitWeightLb: 0.75, fragile: true, fixtureIds: RETAIL_FIXTURES.rangefinder }),
  product({ skuId: 'sunglasses2', status: 'retail', category: 'accessories', physical: dimensions(0.16, 0.06, 0.07), packed: dimensions(0.18, 0.07, 0.08), packedState: 'hard-case-in-padded-cell', packedOrientation: 'case-label-face-up', layoutId: 'ACCESSORY_CARD12', unitWeightLb: 0.15, fragile: true, fixtureIds: RETAIL_FIXTURES.accessories }),
  product({ skuId: 'bottle1', status: 'retail', category: 'accessories', physical: dimensions(0.072, 0.22, 0.072), packed: dimensions(0.072, 0.22, 0.072), packedState: 'retail-bottle-in-divider', packedOrientation: 'upright-labels-out', layoutId: 'DRINK12', unitWeightLb: 0.7, fixtureIds: RETAIL_FIXTURES.accessories }),
  product({ skuId: 'scorecard1', status: 'retail', category: 'accessories', physical: dimensions(0.15, 0.005, 0.105), packed: dimensions(0.15, 0.01, 0.105), packedState: 'banded-scorecard-pack', packedOrientation: 'printed-face-up', layoutId: 'FLAT8', unitWeightLb: 0.05, fixtureIds: RETAIL_FIXTURES.scorecards }),
  product({ skuId: 'sportdrink2', status: 'retail', category: 'accessories', physical: dimensions(0.072, 0.22, 0.072), packed: dimensions(0.072, 0.22, 0.072), packedState: 'sealed-bottle-with-tamper-band', packedOrientation: 'upright-labels-out', layoutId: 'DRINK12', unitWeightLb: 1.2, fixtureIds: RETAIL_FIXTURES.drinks }),
  product({ skuId: 'soda1', status: 'retail', category: 'accessories', physical: dimensions(0.066, 0.122, 0.066), packed: dimensions(0.066, 0.122, 0.066), packedState: 'sealed-can-in-divider', packedOrientation: 'upright-labels-out', layoutId: 'DRINK12', unitWeightLb: 0.8, fixtureIds: RETAIL_FIXTURES.drinks }),
  product({ skuId: 'chips1', status: 'retail', category: 'accessories', physical: dimensions(0.16, 0.195, 0.0715), packed: dimensions(0.16, 0.195, 0.0715), packedState: 'sealed-retail-snack-pouch', packedOrientation: 'upright-labels-out', layoutId: 'SNACK12', unitWeightLb: 0.15, fixtureIds: RETAIL_FIXTURES.snacks }),
  product({ skuId: 'bar2', status: 'retail', category: 'accessories', physical: dimensions(0.15, 0.055, 0.025), packed: dimensions(0.15, 0.055, 0.025), packedState: 'sealed-retail-bar-wrapper', packedOrientation: 'labels-face-up', layoutId: 'SNACK12', unitWeightLb: 0.12, fixtureIds: RETAIL_FIXTURES.snacks }),
  product({ skuId: 'crackers1', status: 'retail', category: 'accessories', physical: dimensions(0.16, 0.195, 0.0715), packed: dimensions(0.16, 0.195, 0.0715), packedState: 'sealed-retail-snack-pouch', packedOrientation: 'upright-labels-out', layoutId: 'SNACK12', unitWeightLb: 0.18, fixtureIds: RETAIL_FIXTURES.snacks }),
  ...
  product({ skuId: 'bag3', status: 'retail', category: 'accessories', physical: dimensions(0.74, 0.265, 0.32), packed: dimensions(0.67, 0.25, 0.32), packedState: 'protective-sleeve-with-straps-compressed', packedOrientation: 'length-axis-vertical', layoutId: 'BAG1', unitWeightLb: 7.5, longProduct: true, fixtureIds: RETAIL_FIXTURES.bag }),
  product({ skuId: 'shoe3', status: 'retail', category: 'apparel', physical: dimensions(0.31, 0.115, 0.19), packed: dimensions(0.32, 0.13, 0.24), packedState: 'pair-in-retail-shoe-box-with-tissue', packedOrientation: 'toe-end-face-front', layoutId: 'SHOE4', unitWeightLb: 2.1, fixtureIds: RETAIL_FIXTURES.shoe }),
  ...
  // The five production chair tiers have explicit one-chair packs. Office
  // chairs ship with the back, gas lift, and caster base separated; the larger
  // club chairs use the furniture crate with feet removed and cushions braced.
  product({ skuId: 'furn-chairs-basic', status: 'nonretail', category: 'decor', physical: dimensions(0.63, 1.04, 0.68), packed: dimensions(0.58, 0.40, 0.36), packedState: 'back-seat-gas-lift-and-caster-base-disassembled', packedOrientation: 'seat-shell-on-side-with-base-nested', layoutId: 'FIXTURE1', unitWeightLb: 33, fixtureIds: ['decor-floor'] }),
  product({ skuId: 'furn-chairs-standard', status: 'nonretail', category: 'decor', physical: dimensions(0.68, 1.12, 0.73), packed: dimensions(0.59, 0.50, 0.37), packedState: 'back-seat-gas-lift-and-caster-base-disassembled', packedOrientation: 'segmented-back-flat-with-base-nested', layoutId: 'FIXTURE1', unitWeightLb: 45, fixtureIds: ['decor-floor'] }),
  product({ skuId: 'furn-chairs-premium', status: 'nonretail', category: 'decor', physical: dimensions(0.78, 1.19, 0.82), packed: dimensions(0.78, 0.55, 0.50), packedState: 'executive-back-arms-seat-and-caster-base-disassembled', packedOrientation: 'back-flat-above-braced-seat-and-base', layoutId: 'FURNITURE1', unitWeightLb: 58, fixtureIds: ['decor-floor'] }),
  product({ skuId: 'furn-chairs-luxury', status: 'nonretail', category: 'decor', physical: dimensions(1.05, 0.92, 0.99), packed: dimensions(1.04, 0.72, 0.76), packedState: 'club-chair-feet-removed-and-cushions-compressed', packedOrientation: 'frame-upright-with-scroll-arms-braced', layoutId: 'FURNITURE1', unitWeightLb: 74, fixtureIds: ['decor-floor'] }),
  product({ skuId: 'furn-chairs-executive', status: 'nonretail', category: 'decor', physical: dimensions(1.20, 0.97, 1.08), packed: dimensions(1.18, 0.82, 0.78), packedState: 'chesterfield-chair-feet-removed-and-cushions-compressed', packedOrientation: 'frame-upright-with-tufted-back-protected', layoutId: 'FURNITURE1', unitWeightLb: 93, fixtureIds: ['decor-floor'] }),
...
// Every authored furniture SKU has a concrete one-piece freight contract. The
// cabinet/frame is shipped knocked down inside the production furniture crate;
// this is catalog generation, not an unknown-SKU or scale-to-fit fallback.
const authoredSkuIds = new Set(PRODUCT_SPECS.map((entry) => entry.skuId));
for (const sku of PRO_SHOP_FURNITURE_SKUS) {
  if (authoredSkuIds.has(sku.id)) continue;
  const [w, h, d] = sku.dimensionsM;
  PRODUCT_SPECS.push(product({
    skuId: sku.id,
    status: 'nonretail',
    category: 'decor',
    physical: dimensions(w, h, d),
    packed: dimensions(1.18, 0.80, 0.78),
    packedState: 'knock-down-furniture-panels-and-hardware-braced',
    packedOrientation: 'largest-panels-lengthwise-with-protected-finish',
    layoutId: 'FURNITURE1',
    unitWeightLb: sku.lb,
    fragile: !!sku.fragile,
    fixtureIds: [sku.placeableProfile?.mount === 'wall' ? 'decor-wall' : 'decor-floor'],
  }));
}
for (const sku of CEILING_LIGHT_SKUS) {
  ...
  PRODUCT_SPECS.push(product({
    ...
    physical: dimensions(w, h, d),
    packed: dimensions(1.18, 0.80, 0.78),
    packedState: 'fixture-disassembled-with-diffusers-and-hardware-braced',
    packedOrientation: 'longest-frame-lengthwise-with-fragile-parts-protected',
    layoutId: 'FURNITURE1',
    unitWeightLb: sku.lb,
    fragile: !!sku.fragile,
    fixtureIds: ['decor-ceiling'],
  }));
}
