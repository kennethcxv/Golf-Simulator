...
const ARCHETYPES = [
  {
    id: STARTING_PROPERTY_ID,
    name: STARTING_PROPERTY_NAME,
    blurb: 'A neglected three-hole muni starter: honest routing, three sick greens, and a clubhouse that needs hands-on restoration.',
    size: 3,
    // The Course-1 reference building: the authored Pine Hills kit whose
    // exterior and components carry real dilapidated/restored states. The
    // modern-public presentation belongs to the next property tier.
    clubhouseVariant: 'pine-hills',
    layout: { kind: 'willow' },
    condition: 46,
    sickGreens: 3,
...
export function buildPropertyCourse(property) {
  ...
  // Three- and nine-hole properties are architect-designed vector courses now — one
