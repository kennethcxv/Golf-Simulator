...
## Current state (2026-07-23 recovery session)

- **Branch** `feature/pro-shop-furniture` · **Tests 2,279 green** (`npm test` from the repo root)
- **Source of truth for the active recovery:** `docs/GOLF_FLIPPER_MASTER_RECOVERY_SPEC.md` (intended behavior/quality) + `docs/GOLF_FLIPPER_OVERNIGHT_EXECUTION.md` (execution order)
- **Defect tracker:** `docs/overnight/known-defects.md` — CHECKOUT-001/ASSET-051-100-001/SEC-ELECTRON-001 resolved 2026-07-23; PERF-001 still open
- **Safety branch** `checkpoint/pre-recovery-2026-07-22` protects the pre-recovery tree
- Everything below this section is the older P0-foundation-overhaul session record; its landmines
  remain true, but its branch/test counts and "next" list predate the recovery session.

## Historical record — the P0 foundation overhaul (branch `main`, 505 tests then)
