...
def build_52() -> bpy.types.Object:
    ...
    roof_patches = [
        _box("RoofMoldSouthWest", (8.1, patch_length, 0.028), (-5.2, -run * 0.45, 5.48), roof_mold, roof, rotation=(slope, 0.0, 0.0), bevel=0.008, properties={**common, "damage_kind": "roof_mold"}),
        _box("RoofMoldSouthEast", (7.0, patch_length * 0.72, 0.028), (5.5, -run * 0.38, 5.34), roof_mold, roof, rotation=(slope, 0.0, 0.0), bevel=0.008, properties={**common, "damage_kind": "roof_mold"}),
