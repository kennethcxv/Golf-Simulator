...
REPO = os.getcwd()
OUT_RENDER = os.path.join(REPO, "qa", "hero", "v3", "apparel")
GLB_DIR = os.path.join(REPO, "Assets", "models", "hero", "v3")
...
def polo_folded(origin=(0, 0, 0), broken=""):
    ...
    tag_hw = 0.0165
    # edge_x returns a WORLD x, which already has the origin in it. Adding ox
    # to it again double-counts the offset. That is invisible at origin 0 --
    # which is every render this has ever had -- and throws the tag 400 mm off
