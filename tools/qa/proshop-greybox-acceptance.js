async (page) => {
  ...
  const measure = () => page.evaluate(async () => {
    ...
    const contract = {
      ...
      greyPresent: names(['GREY_frontCounter', 'GREY_backcounter', 'GREY_chairB', 'GREY_teeTimeBoard', 'GREY_WestWall', 'GREY_NorthWall', 'GREY_Ceiling', 'GREY_CeilingBeam_1', 'GREY_CorridorSeal']),
