// GENERATED by tools/vendor-libs.mjs from three-mesh-bvh@0.9.14 — do not edit by hand.
...
import { Box3 as Box32, Matrix4 } from "three";
var _bufferStack1 = /* @__PURE__ */ new BufferStack.constructor();
var _bufferStack2 = /* @__PURE__ */ new BufferStack.constructor();
var _boxPool = /* @__PURE__ */ new PrimitivePool(() => new Box32());
var _leftBox1 = /* @__PURE__ */ new Box32();
var _rightBox1 = /* @__PURE__ */ new Box32();
var _leftBox2 = /* @__PURE__ */ new Box32();
var _rightBox2 = /* @__PURE__ */ new Box32();
var _active = false;
...
// node_modules/three-mesh-bvh/src/core/BVH.js
var _tempBox = /* @__PURE__ */ new Box33();
...
var GeometryBVH = class extends BVH {
  ...
  init(options) {
    ...
    if (!geometry.boundingBox && options.setBoundingBox) {
      geometry.boundingBox = this.getBoundingBox(new Box34());
    }
  }
...
import { BufferAttribute as BufferAttribute2, FrontSide, Ray, Vector3 as Vector310, Matrix4 as Matrix47 } from "three";

// node_modules/three-mesh-bvh/src/math/OrientedBox.js
import { Vector3 as Vector34, Matrix4 as Matrix42, Line3 as Line33 } from "three";
...
import { Triangle, Vector3 as Vector33, Vector2 as Vector22, Line3 as Line32, Plane as Plane2 } from "three";

// node_modules/three-mesh-bvh/src/math/MathUtilities.js
import { Vector3 as Vector32, Vector2, Plane, Line3 } from "three";
var closestPointLineToLine = /* @__PURE__ */ (function() {
  const dir1 = /* @__PURE__ */ new Vector32();
  const dir2 = /* @__PURE__ */ new Vector32();
  const v02 = /* @__PURE__ */ new Vector32();
...
var closestPointsSegmentToSegment = /* @__PURE__ */ (function() {
  ...
  const temp14 = /* @__PURE__ */ new Vector32();
  const temp23 = /* @__PURE__ */ new Vector32();
...
var sphereIntersectTriangle = /* @__PURE__ */ (function() {
  const closestPointTemp = /* @__PURE__ */ new Vector32();
  const projectedPointTemp = /* @__PURE__ */ new Vector32();
...
var ExtendedTriangle = class extends Triangle {
  constructor(...args) {
    ...
    this.satAxes = new Array(4).fill().map(() => new Vector33());
...
ExtendedTriangle.prototype.closestPointToSegment = /* @__PURE__ */ (function() {
  const point1 = /* @__PURE__ */ new Vector33();
  const point2 = /* @__PURE__ */ new Vector33();
  const edge = /* @__PURE__ */ new Line32();
...
ExtendedTriangle.prototype.intersectsTriangle = /* @__PURE__ */ (function() {
  ...
  const tmpVec = /* @__PURE__ */ new Vector33();
  const dir1 = /* @__PURE__ */ new Vector33();
  const dir2 = /* @__PURE__ */ new Vector33();
  const tempDir = /* @__PURE__ */ new Vector33();
  const edge1 = /* @__PURE__ */ new Line32();
  const edge2 = /* @__PURE__ */ new Line32();
  const tempPoint = /* @__PURE__ */ new Vector33();
  const bounds1 = /* @__PURE__ */ new Vector22();
  const bounds2 = /* @__PURE__ */ new Vector22();
...
ExtendedTriangle.prototype.distanceToPoint = /* @__PURE__ */ (function() {
  const target = /* @__PURE__ */ new Vector33();
...
ExtendedTriangle.prototype.distanceToTriangle = /* @__PURE__ */ (function() {
  const point = /* @__PURE__ */ new Vector33();
  const point2 = /* @__PURE__ */ new Vector33();
  const cornerFields = ["a", "b", "c"];
  const line1 = /* @__PURE__ */ new Line32();
  const line2 = /* @__PURE__ */ new Line32();
...
var OrientedBox = class {
  constructor(min, max, matrix2) {
    ...
    this.min = new Vector34();
    this.max = new Vector34();
    this.matrix = new Matrix42();
    this.invMatrix = new Matrix42();
    this.points = new Array(8).fill().map(() => new Vector34());
    this.satAxes = new Array(3).fill().map(() => new Vector34());
...
OrientedBox.prototype.intersectsTriangle = /* @__PURE__ */ (function() {
  ...
  const cachedSatBounds = /* @__PURE__ */ new SeparatingAxisBounds();
  const cachedSatBounds2 = /* @__PURE__ */ new SeparatingAxisBounds();
  const cachedAxis = /* @__PURE__ */ new Vector34();
...
OrientedBox.prototype.distanceToBox = /* @__PURE__ */ (function() {
  ...
  const segments1 = /* @__PURE__ */ new Array(12).fill().map(() => new Line33());
  const segments2 = /* @__PURE__ */ new Array(12).fill().map(() => new Line33());
  const point1 = /* @__PURE__ */ new Vector34();
  const point2 = /* @__PURE__ */ new Vector34();
...
var temp = /* @__PURE__ */ new Vector35();
var temp1 = /* @__PURE__ */ new Vector35();
...
import { Vector3 as Vector36, Vector2 as Vector23, Triangle as Triangle2, DoubleSide, BackSide, REVISION } from "three";
var IS_GT_REVISION_169 = parseInt(REVISION) >= 169;
var IS_LT_REVISION_161 = parseInt(REVISION) <= 161;
var _vA = /* @__PURE__ */ new Vector36();
var _vB = /* @__PURE__ */ new Vector36();
var _vC = /* @__PURE__ */ new Vector36();
var _uvA = /* @__PURE__ */ new Vector23();
var _uvB = /* @__PURE__ */ new Vector23();
var _uvC = /* @__PURE__ */ new Vector23();
var _normalA = /* @__PURE__ */ new Vector36();
var _normalB = /* @__PURE__ */ new Vector36();
var _normalC = /* @__PURE__ */ new Vector36();
var _intersectionPoint = /* @__PURE__ */ new Vector36();
...
function checkBufferGeometryIntersection(ray, position, normal, uv, uv1, a, b, c, side, near, far) {
  ...
  if (intersection) {
    ...
    if (normal) {
      ...
      intersection.normal = new Vector36();
...
import { Vector2 as Vector24, Vector3 as Vector37, Triangle as Triangle3 } from "three";
...
var tempV1 = /* @__PURE__ */ new Vector37();
var tempV2 = /* @__PURE__ */ new Vector37();
var tempV3 = /* @__PURE__ */ new Vector37();
var tempUV1 = /* @__PURE__ */ new Vector24();
var tempUV2 = /* @__PURE__ */ new Vector24();
var tempUV3 = /* @__PURE__ */ new Vector24();
function getTriangleHitPointInfo(point, geometry, triangleIndex, target) {
  ...
  const barycoord = target && target.barycoord ? target.barycoord : new Vector37();
  Triangle3.getBarycoord(point, tempV1, tempV2, tempV3, barycoord);
  let uv = null;
  if (uvs) {
    ...
    else uv = new Vector24();
    Triangle3.getInterpolation(point, tempV1, tempV2, tempV3, tempUV1, tempUV2, tempUV3, uv);
  }
  if (target) {
    ...
    if (!target.face.normal) target.face.normal = new Vector37();
    Triangle3.getNormal(tempV1, tempV2, tempV3, target.face.normal);
    if (uv) target.uv = uv;
    ...
    return {
      face: {
        ...
        c,
        materialIndex,
        normal: Triangle3.getNormal(tempV1, tempV2, tempV3, new Vector37())
      },
      uv,
      barycoord
    };
...
import { Box3 as Box35, Matrix4 as Matrix43 } from "three";
var boundingBox = /* @__PURE__ */ new Box35();
var triangle = /* @__PURE__ */ new ExtendedTriangle();
var triangle2 = /* @__PURE__ */ new ExtendedTriangle();
var invertedMat = /* @__PURE__ */ new Matrix43();
...
import { Matrix4 as Matrix44, Vector3 as Vector38 } from "three";
var tempMatrix = /* @__PURE__ */ new Matrix44();
var obb3 = /* @__PURE__ */ new OrientedBox();
var obb22 = /* @__PURE__ */ new OrientedBox();
var temp12 = /* @__PURE__ */ new Vector38();
var temp2 = /* @__PURE__ */ new Vector38();
var temp3 = /* @__PURE__ */ new Vector38();
var temp4 = /* @__PURE__ */ new Vector38();
...
import { Box3 as Box36, Matrix4 as Matrix45 } from "three";
var boundingBox2 = /* @__PURE__ */ new Box36();
var triangle3 = /* @__PURE__ */ new ExtendedTriangle();
var triangle22 = /* @__PURE__ */ new ExtendedTriangle();
var invertedMat2 = /* @__PURE__ */ new Matrix45();
...
import { Matrix4 as Matrix46, Vector3 as Vector39 } from "three";
var tempMatrix2 = /* @__PURE__ */ new Matrix46();
var obb5 = /* @__PURE__ */ new OrientedBox();
var obb24 = /* @__PURE__ */ new OrientedBox();
var temp13 = /* @__PURE__ */ new Vector39();
var temp22 = /* @__PURE__ */ new Vector39();
var temp32 = /* @__PURE__ */ new Vector39();
var temp42 = /* @__PURE__ */ new Vector39();
...
var _direction = /* @__PURE__ */ new Vector310();
var _inverseMatrix = /* @__PURE__ */ new Matrix47();
var _worldScale = /* @__PURE__ */ new Vector310();
...
import { Matrix4 as Matrix48, Line3 as Line34, Vector3 as Vector311, Ray as Ray2, Box3 as Box37 } from "three";
var _inverseMatrix2 = /* @__PURE__ */ new Matrix48();
var _ray2 = /* @__PURE__ */ new Ray2();
var _linePool = /* @__PURE__ */ new PrimitivePool(() => new Line34());
var _intersectPointOnRay = /* @__PURE__ */ new Vector311();
var _intersectPointOnSegment = /* @__PURE__ */ new Vector311();
var _box = /* @__PURE__ */ new Box37();
var _vec = /* @__PURE__ */ new Vector311();
  ...
  raycastObject3D(object, raycaster, intersects = []) {
    ...
    this.shapecast({
      ...
      intersectsBounds: (box) => {
        ...
        if (firstHitOnly) {
          if (!_ray2.intersectBox(_box, _vec)) {
            return NOT_INTERSECTED;
          }
          let dist;
          if (_box.containsPoint(_ray2.origin)) {
            dist = 0;
          } else {
...
import { Vector3 as Vector312, Matrix4 as Matrix49, Ray as Ray3, Box3 as Box38 } from "three";
var _inverseMatrix3 = /* @__PURE__ */ new Matrix49();
var _ray3 = /* @__PURE__ */ new Ray3();
var _pointPool = /* @__PURE__ */ new PrimitivePool(() => new Vector312());
var _box3 = /* @__PURE__ */ new Box38();
var _vec2 = /* @__PURE__ */ new Vector312();
var PointsBVH = class extends GeometryBVH {
  ...
  raycastObject3D(object, raycaster, intersects = []) {
    ...
    this.shapecast({
      ...
      intersectsBounds: (box) => {
        _box3.copy(box).expandByScalar(localThreshold);
        if (firstHitOnly) {
          if (!_ray3.intersectBox(_box3, _vec2)) {
            return NOT_INTERSECTED;
          }
          let dist;
          if (_box3.containsPoint(_ray3.origin)) {
            dist = 0;
          } else {
            _vec2.applyMatrix4(matrixWorld);
            dist = raycaster.ray.origin.distanceTo(_vec2);
          }
          return dist < closestDistance ? INTERSECTED : NOT_INTERSECTED;
        } else {
      ...
      intersectsPoint: (point, index) => {
        ...
        if (rayPointDistanceSq < localThresholdSq) {
          const intersectPoint = new Vector312();
...
import { Box3 as Box39, BufferGeometry, Matrix4 as Matrix410, Mesh, Vector3 as Vector313, Ray as Ray4, Sphere } from "three";
var _geometry = /* @__PURE__ */ new BufferGeometry();
var _matrix = /* @__PURE__ */ new Matrix410();
var _inverseMatrix4 = /* @__PURE__ */ new Matrix410();
var _box4 = /* @__PURE__ */ new Box39();
var _sphere = /* @__PURE__ */ new Sphere();
var _vec3 = /* @__PURE__ */ new Vector313();
var _ray4 = /* @__PURE__ */ new Ray4();
...
var ObjectBVH = class extends BVH {
  constructor(root, options = {}) {
    options = {
      ...
      matrixWorld: Array.isArray(root) ? new Matrix410() : root.matrixWorld,
      targetLeafSize: 1,
      ...options
    };
    super();
  ...
  raycast(raycaster, intersects = []) {
    ...
    this.shapecast({
      ...
      intersectsBounds: (box) => {
        if (firstHitOnly) {
          if (!_ray4.intersectBox(box, _vec3)) {
            return NOT_INTERSECTED;
          }
          let dist;
          if (box.containsPoint(_ray4.origin)) {
            dist = 0;
          } else {
            _vec3.applyMatrix4(matrixWorld);
            dist = raycaster.ray.origin.distanceTo(_vec3);
          }
          return dist < closestDistance ? INTERSECTED : NOT_INTERSECTED;
        } else {
...
function getPreciseBounds(geometry, matrix2, target) {
  ...
  for (let i = start, l = start + count; i < l; i++) {
    ...
    _vec3.fromBufferAttribute(posAttr, vi).applyMatrix4(matrix2);
    target.expandByPoint(_vec3);
  }
  return target;
}
...
function shrinkToSphere(box, sphere) {
  _vec3.copy(sphere.center).addScalar(-sphere.radius);
  box.min.max(_vec3);
  _vec3.copy(sphere.center).addScalar(sphere.radius);
  box.max.min(_vec3);
}
...
import { Vector3 as Vector314, Vector2 as Vector25, Ray as Ray5, Matrix4 as Matrix411, FrontSide as FrontSide2, BackSide as BackSide2, Triangle as Triangle4, REVISION as REVISION2 } from "three";
var _v0 = /* @__PURE__ */ new Vector314();
var _v1 = /* @__PURE__ */ new Vector314();
var _v2 = /* @__PURE__ */ new Vector314();
var _ray5 = /* @__PURE__ */ new Ray5();
var _inverseMatrix5 = /* @__PURE__ */ new Matrix411();
var _localPoint = /* @__PURE__ */ new Vector314();
var _vec4 = /* @__PURE__ */ new Vector314();
var _axes = ["x", "y", "z"];
var IS_GT_REVISION_1692 = parseInt(REVISION2) >= 169;
var IS_LT_REVISION_1612 = parseInt(REVISION2) <= 161;
var _uvA2 = /* @__PURE__ */ new Vector25();
var _uvB2 = /* @__PURE__ */ new Vector25();
var _uvC2 = /* @__PURE__ */ new Vector25();
var _normalA2 = /* @__PURE__ */ new Vector314();
var _normalB2 = /* @__PURE__ */ new Vector314();
var _normalC2 = /* @__PURE__ */ new Vector314();
var SkinnedMeshBVH = class extends GeometryBVH {
  ...
  raycastObject3D(object, raycaster, intersects = []) {
    ...
    this.shapecast({
      ...
      intersectsBounds: (box) => {
        if (firstHitOnly) {
          if (!_ray5.intersectBox(box, _vec4)) {
            return NOT_INTERSECTED;
          }
          let dist;
          if (box.containsPoint(_ray5.origin)) {
            dist = 0;
          } else {
            _vec4.applyMatrix4(matrixWorld);
            dist = raycaster.ray.origin.distanceTo(_vec4);
          }
          return dist < closestDistance ? INTERSECTED : NOT_INTERSECTED;
        } else {
        ...
        if (dist >= raycaster.near && dist <= raycaster.far) {
          ...
          const hit = {
            ...
            face: {
              ...
              b: bi,
              c: ci,
              normal: Triangle4.getNormal(tri.a, tri.b, tri.c, new Vector314()),
              materialIndex: 0
            },
            faceIndex: actualTri
          };
          if (IS_GT_REVISION_1692) {
            const barycoord = new Vector314();
            Triangle4.getBarycoord(_localPoint, tri.a, tri.b, tri.c, barycoord);
          ...
          if (uv) {
            ...
            hit.uv = new Vector25();
            const resUv = Triangle4.getInterpolation(_localPoint, tri.a, tri.b, tri.c, _uvA2, _uvB2, _uvC2, hit.uv);
          ...
          if (uv1) {
            ...
            hit.uv1 = new Vector25();
            const resUv1 = Triangle4.getInterpolation(_localPoint, tri.a, tri.b, tri.c, _uvA2, _uvB2, _uvC2, hit.uv1);
          ...
          if (normal) {
            ...
            hit.normal = new Vector314();
            const resNormal = Triangle4.getInterpolation(_localPoint, tri.a, tri.b, tri.c, _normalA2, _normalB2, _normalC2, hit.normal);
...
import { LineBasicMaterial, BufferAttribute as BufferAttribute3, Box3 as Box310, Group, MeshBasicMaterial, Object3D, BufferGeometry as BufferGeometry2, Mesh as Mesh2, Matrix4 as Matrix412, Vector3 as Vector315 } from "three";
var boundingBox3 = /* @__PURE__ */ new Box310();
var matrix = /* @__PURE__ */ new Matrix412();
var vec = /* @__PURE__ */ new Vector315();
var BVHRootHelper = class extends Object3D {
  ...
  getVertexPosition(...args) {
    return Mesh2.prototype.getVertexPosition.call(this, ...args);
  }
  constructor(bvh, material, depth = 10, group = 0) {
    super();
    this.material = material;
    this.geometry = new BufferGeometry2();
  ...
  getGeometry(boundsTree) {
    ...
    geometry.setIndex(new BufferAttribute3(indexArray, 1, false));
    geometry.setAttribute("position", new BufferAttribute3(positionArray, 3, false));
    return geometry;
  }
...
import { Box3 as Box311 } from "three";
var _box12 = /* @__PURE__ */ new Box311();
var _box22 = /* @__PURE__ */ new Box311();
...
function getJSONStructure(bvh) {
  ...
  bvh.traverse((depth, isLeaf, boundingData, offset, count) => {
    const info = {
      bounds: arrayToBox(0, boundingData, new Box311())
    };
    if (isLeaf) {
      info.count = count;
      info.offset = offset;
...
import { Mesh as Mesh3, Points, Line, LineLoop, LineSegments, Sphere as Sphere2, BatchedMesh, REVISION as REVISION3 } from "three";
var IS_REVISION_166 = parseInt(REVISION3) >= 166;
var _raycastFunctions = {
  "Mesh": Mesh3.prototype.raycast,
...
function acceleratedBatchedMeshRaycast(raycaster, intersects) {
  if (this.boundsTrees) {
    ...
    if (_mesh2.geometry.boundingSphere === null) {
      _mesh2.geometry.boundingSphere = new Sphere2();
    }
    ...
    if (bvh.indirect) {
      ...
      if (this._cachedIndexAttr === null || this._cachedIndexAttr.count !== indirectBuffer.length) {
        if (geometry.index) {
          ...
          this._cachedIndexAttr = new BufferAttribute4(array, 1, false);
        }
      }
...
function bvhToTextures(bvh, boundsTexture, contentsTexture) {
  ...
  boundsTexture.minFilter = NearestFilter2;
  boundsTexture.magFilter = NearestFilter2;
  ...
  contentsTexture.minFilter = NearestFilter2;
  contentsTexture.magFilter = NearestFilter2;
...
import { BufferAttribute as BufferAttribute5, BufferGeometry as BufferGeometry3, Vector3 as Vector316, Vector4, Matrix4 as Matrix413, Matrix3 } from "three";
var _positionVector = /* @__PURE__ */ new Vector316();
var _normalVector = /* @__PURE__ */ new Vector316();
var _tangentVector = /* @__PURE__ */ new Vector316();
var _tangentVector4 = /* @__PURE__ */ new Vector4();
var _morphVector = /* @__PURE__ */ new Vector316();
var _temp = /* @__PURE__ */ new Vector316();
var _skinIndex = /* @__PURE__ */ new Vector4();
var _skinWeight = /* @__PURE__ */ new Vector4();
var _matrix2 = /* @__PURE__ */ new Matrix413();
var _boneMatrix = /* @__PURE__ */ new Matrix413();
...
function createAttributeClone(attr, countOverride = null) {
  ...
  return new BufferAttribute5(new cons(itemSize * count), itemSize, normalized);
}
...
function mergeBufferGeometries(geometries, options = { useGroups: false, updateIndex: false, skipAttributes: [] }, targetGeometry = new BufferGeometry3()) {
  ...
  if (isIndexed) {
    ...
    if (!targetGeometry.index) {
      ...
      targetGeometry.setIndex(new BufferAttribute5(new Uint32Array(indexCount), 1, false));
...
var GeometryDiff = class {
  constructor(mesh) {
    this.matrixWorld = new Matrix413();
...
var StaticGeometryGenerator = class {
  ...
  constructor(meshes) {
    ...
    this._intermediateGeometry = new Array(finalMeshes.length).fill().map(() => new BufferGeometry3());
   ...
   */
  generate(targetGeometry = new BufferGeometry3()) {
    let skipAttributes = [];
    ...
    if (_intermediateGeometry.length === 0) {
      ...
      for (const key in this.attributes) {
        targetGeometry.setAttribute(this.attributes[key], new BufferAttribute5(new Float32Array(0), 4, false));
      }
    } else {
  ...
  _convertToStaticGeometry(mesh, targetGeometry = new BufferGeometry3()) {
    const geometry = mesh.geometry;
